...
// Source: canal/pkg/domain/repository/currency.go
...
func (m *MockCurrencyLogic) GetAllLatestCurrencies(ctx context.Context) (entity.Description, entity.Currencies, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllLatestCurrencies", ctx)
...
func (mr *MockCurrencyLogicMockRecorder) GetAllLatestCurrencies(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllLatestCurrencies", reflect.TypeOf((*MockCurrencyLogic)(nil).GetAllLatestCurrencies), ctx)
}
