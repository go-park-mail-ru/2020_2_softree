...
func (m *MockPaymentLogic) ReceiveTransactions(ctx context.Context, in entity.Income) (entity.Description, entity.Payments, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReceiveTransactions", ctx, in)
...
func (mr *MockPaymentLogicMockRecorder) ReceiveTransactions(ctx, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReceiveTransactions", reflect.TypeOf((*MockPaymentLogic)(nil).ReceiveTransactions), ctx, in)
}
...
func (m *MockPaymentLogic) GetAllIncomePerDay(ctx context.Context, in entity.Income) (entity.Description, entity.WalletStates, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllIncomePerDay", ctx, in)
	ret0, _ := ret[0].(entity.Description)
	ret1, _ := ret[1].(entity.WalletStates)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// GetAllIncomePerDay indicates an expected call of GetAllIncomePerDay
func (mr *MockPaymentLogicMockRecorder) GetAllIncomePerDay(ctx, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllIncomePerDay", reflect.TypeOf((*MockPaymentLogic)(nil).GetAllIncomePerDay), ctx, in)
}
