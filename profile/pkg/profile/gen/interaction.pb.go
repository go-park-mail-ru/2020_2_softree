...
var file_interaction_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf3, 0x08, 0x0a, 0x0e, 0x70, 0x72, 0x6f, 0x66,
	...
	,
}
...
var file_interaction_proto_depIdxs = []int32{
	...
	13, // 23: profile.profileService.CreateWallet:input_type -> profile.ConcreteWallet
	14, // 24: profile.profileService.UpdateWallet:input_type -> profile.ToSetWallet
	15, // 25: profile.profileService.GetIncome:input_type -> profile.IncomeParameters
	17, // 26: profile.profileService.PutPortfolio:input_type -> profile.PortfolioValue
	1,  // 27: profile.profileService.SaveUser:output_type -> profile.PublicUser
	18, // 28: profile.profileService.UpdateUserAvatar:output_type -> profile.Empty
	18, // 29: profile.profileService.UpdateUserPassword:output_type -> profile.Empty
	18, // 30: profile.profileService.DeleteUser:output_type -> profile.Empty
	1,  // 31: profile.profileService.GetUserById:output_type -> profile.PublicUser
	1,  // 32: profile.profileService.GetUserByLogin:output_type -> profile.PublicUser
	7,  // 33: profile.profileService.CheckExistence:output_type -> profile.Check
	0,  // 34: profile.profileService.GetPassword:output_type -> profile.User
	3,  // 35: profile.profileService.GetUserWatchlist:output_type -> profile.Currencies
	5,  // 36: profile.profileService.GetUsers:output_type -> profile.UsersCount
	9,  // 37: profile.profileService.GetAllPaymentHistory:output_type -> profile.AllHistory
	18, // 38: profile.profileService.AddToPaymentHistory:output_type -> profile.Empty
	12, // 39: profile.profileService.GetWallets:output_type -> profile.Wallets
	11, // 40: profile.profileService.GetWallet:output_type -> profile.Wallet
	18, // 41: profile.profileService.SetWallet:output_type -> profile.Empty
	7,  // 42: profile.profileService.CheckWallet:output_type -> profile.Check
	18, // 43: profile.profileService.CreateWallet:output_type -> profile.Empty
	18, // 44: profile.profileService.UpdateWallet:output_type -> profile.Empty
	16, // 45: profile.profileService.GetIncome:output_type -> profile.Income
	18, // 46: profile.profileService.PutPortfolio:output_type -> profile.Empty
